...
namespace PRGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Ability_Player_Crystal, "Ability.Player.Crystal", "플레이어 크리스탈 상호작용 어빌리티");
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Event_Ability_Crystal_Start, "Event.Ability.Crystal.Start", "크리스탈 상호작용 시작");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Event_Ability_Crystal_End, "Event.Ability.Crystal.End", "크리스탈 상호작용 취소");
